 ...
 * This file demonstrates how to integrate Web3solidity with a web frontend
 */

// For React/Vue/Angular applications
export class Web3solidityClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Web3solidityClient(provider, contractAddress);
