...
const contractABI = require("../artifacts/contracts/Web3solidity.sol/Web3solidity.json").abi;

program
    .name("web3solidity-cli")
    .description("CLI tool for Web3solidity smart contract")
    .version("1.0.0");
